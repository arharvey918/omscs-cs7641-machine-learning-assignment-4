...
public class EasyGridWorldLauncher {
    ...
    private static Integer MAX_ITERATIONS = 20000;
    private static Integer NUM_INTERVALS = 1;
    private static Integer REPEATS = 1;
...
//	private static Integer mapLen = map.length-1;
    ...
    public static void main(String[] args) {
        ...
        // Count states
        System.out.printf("Grid world has %d states\n", StateCounter.countStates(map));
        ...
        AnalysisRunner runner = new AnalysisRunner(MAX_ITERATIONS, NUM_INTERVALS, REPEATS);
